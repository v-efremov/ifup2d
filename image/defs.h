...
#pragma pack(1)
typedef struct tagBITMAPFILEHEADER1   //структура, заголовок bmp файла
{
...
#pragma pack(1)
typedef struct tagBITMAPINFOHEADER1   //структура, информационный заголовок файла
{
...
{
    struct tagBITMAPFILEHEADER1 fh;   //структура, заголовок bmp файла
    struct tagBITMAPINFOHEADER1 ih;   //структура, информационный заголовок файла
} BMPHEADER;
